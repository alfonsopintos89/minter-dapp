...
// ** REQUIRED **
const AUTH = "ae0165e4-d3fa-4211-8f96-7fca73b3a6b2"; // Set this in the .env file to prevent exposing your API key when pushing to Github
...
const ROYALTY_ADDRESS = "0x0a00A667f282F8f37887f706278db9E07BC40003"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = []; // only update if you want to manually set the whitelisted addresses

// ** OPTIONAL **
let CONTRACT_ADDRESS = "0x40f0231a37d1bbf1438524fcacffc8e1ef4d0828"; // If you want to manually include it
